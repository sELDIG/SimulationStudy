...
image.real3d <- function(mat, mat2, xCol = c("darkblue","blue", "lightblue", "gray94", "pink","red", "darkred"), 
  ...
  axis(3, at = seq(5, 45, by = 10), labels = substr(y.labels, 1, 3), las = 1)
...
alt.x.labels[c(2, 8, 12, 15, 16, 17, 18, 19)] = c("tree length", "Yule-PDA ratio", "mean I'", "MGL principal eigenvalue", "MGL asymmetry", "MGL peakedness", "MGL_eigengap", "nLTT stat")

# Modifying a few model abbreviations here (e.g. am and pw)
dimnames(R2MatFull)[[3]] = c("ca", "fh", "gen", "hs", "am", "pw", "ve", "xe")

image.real3d(R2MatFull, signMatFull, x.labels = alt.x.labels)
